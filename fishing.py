...
class Fishing: #класс рыбалка
    ...
    ves=[(350,650),(1750,2550),(3750,4250),(2400,2600),(3500,4500),(382,750),(975,1500),(2750,5000),(4000,7500),(115,200),(1,10),(500,1400)]#вес рыбы
    def __init__(self):#
    ...
    def get_fish(self, i:int, ran:int) ->Fish:#сохранение
        if (self.shans[i][0] <= ran and ran <= self.shans[i][1]):#шанс
            return Fish(self.vid[i],random.randint(self.ves[i][0], self.ves[i][1]), self.price[i])
        else:
            return None